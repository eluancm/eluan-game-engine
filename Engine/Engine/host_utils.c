...
Example of why this is needed: two different floating point binary values
may be different but compare to be true when using floating point comparison,
thus affecting snapshot checksums because the difference won't be sent.
Returns "true" if both data are equal up to the specified size.
===================
*/
